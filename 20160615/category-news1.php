...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php bloginfo('template_directory') ?>/css/NewsCSS.css">
    <!-- Nav Menu -->
...
<!--------------------------------------------- /Header ---------------------------------------------------->
    <div id="qs1" class="queueslider">
        <ul class="queue">
            ...
            <li><img src="http://www.ixd.ntut.edu.tw/wp-content/uploads/2016/05/2015-新一代設計展-2.jpg" />
                <div class="queue_title">2015 新一代設計展</div>
            </li>
            <li><img src="http://www.ixd.ntut.edu.tw/wp-content/uploads/2016/05/2015-新一代設計展-1.jpg" />
                <div class="queue_title">2015 新一代設計展</div>
            </li>
        </ul>
    </div>
    ...
    <div class="Newsfilter">
        <a class="filter active" data-filter="award" href="">Award News</a>
        <span>|</span>
        <a class="filter" data-filter="competition" href="">competition News</a>
        <span>|</span>
        <a class="filter" data-filter="academic" href="">Academic Activities</a>
        </br>
        <a class="filter" data-filter="intern" href="">Internshop & employment</a>
        <span>|</span>
        <a class="filter" data-filter="admission" href="">admission</a>
    </div>
    -->
    <!--Award News獲獎消息  competition News競賽資訊 Academic Activities系所消息 Internshop & employment實習徵才 admission入學資訊-->
    <ul id="filters" class="Newsfilter clearfix">
        <li><span class="filter" data-filter=".news1">全部消息</span></li>
        <li>|</li>
        <li><span class="filter" data-filter=".award">得獎消息</span></li>
        <li>|</li>
        <li><span class="filter" data-filter=".competition">競賽資訊</span></li>
        <li>|</li>
        <li><span class="filter" data-filter=".academic">學術活動</span></li>
        </br>
        <li><span class="filter" data-filter=".intern">徵才實習</span></li>
        <li>|</li>
        <li><span class="filter" data-filter=".admission">招生資訊</span></li>
        <li>|</li>
        <li><span class="filter" data-filter=".announcement">系所公告</span></li>
    </ul>

    <div id="Container" class="news-frame">
        <!--<?php $the_query = new WP_Query( array('cat' =>'3,4,5,6,7' ,'posts_per_page' => -1) ); ?>-->
        <?php $the_query = new WP_Query( array('cat' =>'61,63,64,65,66,70' ,'posts_per_page' => -1) ); ?>
        <?php if ( $the_query->have_posts() ) : ?>
        <?php while ( $the_query->have_posts() ): ?>
        <?php $the_query->the_post(); ?>
        <div class="mix news <?php foreach(get_the_category() as $category) { echo $category->slug . ' ';} ?>" >  <!--get category-->
        <a id="Modal01" class="Modal-link animatedModal" href="<?php the_permalink(); ?>" rel="<?php the_ID(); ?>">
            <div class="news-img">
        ...
        <!--
            ...
            <div class="news"><div class="news-img"></div></div>
            <div class="news"><div class="news-text"></div></div>
            <div class="news"><div class="news-img"></div></div>
            <div class="news"><div class="news-img"></div></div>
            <div class="news"><div class="news-text"></div></div>
            <div class="news"><div class="news-img"></div></div>
